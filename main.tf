...
resource "aws_organizations_organizational_unit" "ou" {
  ...
  parent_id = var.organizational_units[count.index].parent_id != null ? var.organizational_units[count.index].parent_id : aws_organizations_organization.org.0.roots.0.id
}
